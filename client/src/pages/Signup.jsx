...
//         <div className="w-full max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between bg-[#1f1f3a]/90 p-8 rounded-2xl shadow-2xl border border-[#3a3a8a] backdrop-blur-md z-10 animate-fade-in border-4 border-teal-400/50 transition-all duration-700 ease-in-out group">
          ...
          <div className="w-full md:w-1/2">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                ...
                className="w-full bg-blue-700 hover:bg-blue-800 py-2 rounded-xl text-white font-semibold transition duration-200"
              >
              ...
              <button
                type="button"
                onClick={verifyOtp}
                className="w-full bg-purple-600 hover:bg-purple-700 py-2 rounded-xl text-white font-semibold transition duration-200"
              >
                Verify OTP
              </button>
