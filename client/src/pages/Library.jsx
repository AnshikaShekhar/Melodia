...
//         pop: ["pop", "pop-rock", "pop-rap", "synth-pop"],
//         rock: ["rock", "pop-rock", "indie-rock", "alt-rock"],
//         hiphop: ["hip-hop", "rap", "pop-rap", "trap"],
//         rnb: ["r&b", "soul", "neo-soul"],
//         country: ["country", "folk", "country-pop"],
//         electronic: ["edm", "electronic", "synth-pop"],
//         alternative: ["alternative", "alt-rock", "indie", "punk"],
//       };

//       const findGenreCategory = (genre) => {
//         const g = normalizeGenre(genre);
//         for (const [category, synonyms] of Object.entries(genreSimilarityMap)) {
//           if (synonyms.includes(g)) return category;
//         }
//         return "pop";
//       };

//       const likedCategories = new Set(
//         likedSongs.map((song) => findGenreCategory(song.genre))
//       );

//       const smartSongs = allSongs.filter((song) => {
//         const songCategory = findGenreCategory(song.genre);
//         const alreadyLiked = likedSongs.some((liked) => liked._id === song._id);
//         return likedCategories.has(songCategory) && !alreadyLiked;
//       });
